...
public class CallCountJob {
    ...
    public void printStatistics() {
        if (callCount1 != null)
            System.out.println("[api] calls in last 1 min: " + (travisService.getCallCount() - callCount1) + " (max 100)");
        if (callCount5 != null)
            System.out.println("[api] calls in last 5 min: " + (travisService.getCallCount() - callCount5) + " (max 300)");
        if (callCount10 != null)
            System.out.println("[api] calls in last 10 min: " + (travisService.getCallCount() - callCount10) + " (max 1000)");
    }
